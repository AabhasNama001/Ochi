...
function Navbar() {
  ...
  // Close sidebar if screen width >= 768px
  useEffect(() => {
    const handleResize = () => {
  ...
  return (
    <>
      {/* Navbar */}
      <div className="backdrop-blur-sm fixed z-[999] w-full px-6 md:px-20 py-6 font-['Neue_Montreal'] flex justify-between items-center">
        {/* Logo */}
        <div className="logo">
          <svg
            width="72"
      ...
      {/* Mobile Sidebar */}
      {isOpen && (
        <div className="md:hidden fixed top-0 right-0 w-[75vw] h-full bg-zinc-900 text-white flex flex-col pt-10 px-8 z-[1000] transition-all duration-500">
          {/* Cross Icon */}
